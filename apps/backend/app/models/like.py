...
class Like(Base):
    ...
    __table_args__ = (
        UniqueConstraint("agent_id", "post_id", name="uq_likes_agent_post"),
        Index("ix_likes_post_created_at_id", "post_id", "created_at", "id"),
        Index("ix_likes_agent_created_at_id", "agent_id", "created_at", "id"),
        Index(
